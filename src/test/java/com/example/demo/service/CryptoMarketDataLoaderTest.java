...
public class CryptoMarketDataLoaderTest {
  ...
  private CryptoMarketDataCSVLoadService csvLoadService;

  @BeforeEach
  public void setUp(){
    csvLoadService = new CryptoMarketDataCSVLoadService(resourceLoader);
  }
  ...
  public void shouldLoadAllCryptoMarketData() throws IOException{
    ...
    List<CryptoMarketData> dataList = csvLoadService.loadCryptoMarketData();
